...
public class Registerpatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField4.setText("Enter date of birth");

        label1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        label1.setForeground(new java.awt.Color(255, 0, 0));
        label1.setText("S Name");

        textField1.setText("Second Name");

        jCheckBox1.setBackground(new java.awt.Color(255, 102, 102));
        jCheckBox1.setText("Click");
        jCheckBox1.setActionCommand("click");

        jTextField5.setText("Terms and Conditions");
        ...
        jLabel9.setText("               Conversation");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("1. The blood test was successfull.\n2.The results are fair not that bad.\n3.I recomend to take water everyday to replace water lost.\n4.Signs and symptoms of malaria present\n5.High body temperatures.\n");
        ...
        jTabbedPane2.addTab("Doctors Diagnosis", jPanel4);

        jInternalFrame3.setVisible(true);

        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jTextArea2.setText("Take one capsule in the morning and two in the evening everyday.\n");
        ...
        jTabbedPane3.addTab("Pharmacy Prescription", jPanel5);
